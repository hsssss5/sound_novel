...
const instructionsBody = [
  ...
  'Продолжительность маршрута: ~3,5 часа.',
  'Длина маршрута: ~6 км.',
  'Вам понадобятся полностью заряженный телефон и наушники.',
...
export const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    body: [
      'Начальная точка — библиотека «Измайловская» (Измайловский пр-т, 18).',
  ...
  },
  {
    ...
    body: [
      ...
      'Прослушайте аудиофрагмент, выйдя из библиотеки «Измайловская». После завершения прослушивания нажмите «Далее» или «Истории по пути», чтобы узнать о домах, мимо которых вы будете проходить.',
    ].join('\n\n'),
    secondaryAction: {
  ...
  },
  {
    ...
    secondaryAction: {
      label: listenHistoryAction.label,
      materialIds: ['mendeleev', 'konstantinovsky'],
    },
  },
  {
    id: 'cp-3',
  ...
  },
  {
    ...
    body: [
      ...
      'Прослушайте аудиофрагмент, выйдя из Измайловского сада. После завершения прослушивания нажмите «Далее» или «Истории по пути», чтобы узнать историю о доме Гарновского.',
    ].join('\n\n'),
    secondaryAction: {
      label: listenHistoryAction.label,
  ...
  },
  {
    ...
    body: [
      ...
      'Прослушайте аудиофрагмент, перейдя Египетский мост. После завершения прослушивания нажмите «Далее» или «Истории по пути», чтобы узнать легенду, связанную с Египетским мостом.',
    ].join('\n\n'),
    secondaryAction: {
      label: listenHistoryAction.label,
  ...
  },
  {
    ...
    body: [
      ...
      'Прослушайте аудиофрагмент, выйдя из Никольского сада. После завершения прослушивания нажмите «Далее» или «Истории по пути», чтобы узнать легенды, связанные с Никольским Морским собором и… старушками.',
    ].join('\n\n'),
    secondaryAction: {
      label: listenHistoryAction.label,
